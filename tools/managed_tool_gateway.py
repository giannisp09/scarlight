...
def auth_json_path():
    """Return the Scarlight auth store path, respecting SCARLIGHT_HOME overrides."""
    return get_scarlight_home() / "auth.json"
...
def read_nous_access_token() -> Optional[str]:
    ...
    try:
        from scarlight_cli.auth import resolve_nous_access_token
