...
Trust levels:
  - builtin:   Ships with Scarlight. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.scarlight/\.env|\~/\.scarlight/\.env',
     "scarlight_env_access", "critical", "exfiltration",
     "directly references Scarlight secrets file"),
    ...
    (r'\.scarlight/config\.yaml|\.scarlight/SOUL\.md',
     "scarlight_config_mod", "critical", "persistence",
     "references Scarlight configuration files directly"),
