# Streaming LLM Response Support for Scarlight Agent
...
```
SCARLIGHT_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("SCARLIGHT_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `scarlight_cli/config.py` | 1 | +streaming config defaults |
...
SCARLIGHT_STREAMING_ENABLED=true
```
