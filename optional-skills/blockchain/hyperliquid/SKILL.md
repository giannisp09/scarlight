...
The script reads `~/.scarlight/.env` for two optional defaults:
...
Helper script: `~/.scarlight/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.scarlight/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `~/.scarlight/.env`.
...
```bash
python3 ~/.scarlight/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.scarlight/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
