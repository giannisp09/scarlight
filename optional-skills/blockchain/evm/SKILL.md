...
Helper script path: `~/.scarlight/skills/blockchain/evm/scripts/evm_client.py`
...
```
SCRIPT=~/.scarlight/skills/blockchain/evm/scripts/evm_client.py
...
python3 ~/.scarlight/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python3 ~/.scarlight/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```
