...
Data file: $SCARLIGHT_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_SCARLIGHT_HOME = Path(os.environ.get("SCARLIGHT_HOME", Path.home() / ".scarlight"))
DATA_DIR = _SCARLIGHT_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
