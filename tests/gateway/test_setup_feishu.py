"""Tests for _setup_feishu() in scarlight_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("scarlight_cli.gateway.save_env_value", side_effect=mock_save), \
         patch("scarlight_cli.gateway.get_env_value", side_effect=mock_get), \
         patch("scarlight_cli.gateway.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("scarlight_cli.gateway.prompt_choice", side_effect=prompt_choice_responses), \
         patch("scarlight_cli.gateway.prompt", side_effect=prompt_responses), \
         patch("scarlight_cli.gateway.print_info"), \
         patch("scarlight_cli.gateway.print_success"), \
         patch("scarlight_cli.gateway.print_warning"), \
         patch("scarlight_cli.gateway.print_error"), \
         patch("scarlight_cli.gateway.color", side_effect=lambda t, c: t), \
         patch("gateway.platforms.feishu.qr_register", return_value=qr_result):

        from scarlight_cli.gateway import _setup_feishu
        _setup_feishu()
