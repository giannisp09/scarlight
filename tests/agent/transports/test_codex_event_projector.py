"""Tests for CodexEventProjector — codex item/* events → Scarlight messages list.
...
class TestRoleAlternationInvariant:
    ...
    one item — that breaks Scarlight' message alternation invariant."""
