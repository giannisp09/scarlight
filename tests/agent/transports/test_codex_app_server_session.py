...
class TestServerRequestRouting:
    ...
    def test_mcp_elicitation_for_scarlight_tools_auto_accepts(self):
        """When codex elicits on behalf of scarlight-tools (our own callback),
