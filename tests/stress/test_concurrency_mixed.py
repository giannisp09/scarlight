...
def worker_loop(worker_id: int, scarlight_home: str, result_file: str) -> None:
...
def reclaimer_loop(scarlight_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="scarlight_mixed_stress_")
    print(f"SCARLIGHT_HOME = {home}")
