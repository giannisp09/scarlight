...
old_session_id=<old>). This lets plugin engines (e.g. scarlight-lcm) preserve
DAG lineage across the split instead of treating it as a fresh /new.

See scarlight-lcm#68: after Scarlight compresses and mints a new physical session,
