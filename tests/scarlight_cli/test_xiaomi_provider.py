...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from scarlight_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in SCARLIGHT_OVERLAYS
        overlay = SCARLIGHT_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify scarlight doctor recognizes Xiaomi env vars."""
