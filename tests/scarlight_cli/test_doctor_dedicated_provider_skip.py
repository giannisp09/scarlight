"""Regression: scarlight doctor must not run a generic Bearer-auth health
...
with HTTP 404. The dedicated check at scarlight_cli/doctor.py already covers
...
def test_build_apikey_providers_list_skips_dedicated_check_providers():
    from scarlight_cli import doctor
