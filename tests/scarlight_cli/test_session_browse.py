"""Tests for the interactive session browser (`scarlight sessions browse`).
...
from scarlight_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """scarlight sessions browse should be parseable."""
        from scarlight_cli.main import main as _main_entry
