...
The main() function in scarlight_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `scarlight -c model`
...
def _build_parser():
    """Build a minimal replica of the scarlight top-level parser."""
