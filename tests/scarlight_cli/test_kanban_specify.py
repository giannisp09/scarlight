"""Tests for the specifier module + `scarlight kanban specify` CLI surface.
...
from scarlight_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `scarlight kanban …` argparse surface directly."""
