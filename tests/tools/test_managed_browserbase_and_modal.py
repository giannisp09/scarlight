...
def _enable_managed_nous_tools(monkeypatch):
    ...
    scarlight_cli.auth and scarlight_cli.models — so the function body returns True.
    """
    monkeypatch.setattr("scarlight_cli.auth.get_nous_auth_status", lambda: {"logged_in": True})
    monkeypatch.setattr("scarlight_cli.models.check_nous_free_tier", lambda: False)
