...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("scarlight_cli.config.get_config_path", return_value=config_path), \
             patch("scarlight_cli.config.ensure_scarlight_home"):
    ...
    def test_ensure_scarlight_home_sets_0700(self):
        home = Path(self.tmpdir) / ".scarlight"
        with patch("scarlight_cli.config.get_scarlight_home", return_value=home):
