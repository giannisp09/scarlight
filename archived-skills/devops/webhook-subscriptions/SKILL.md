...
- Subscriptions persist to `~/.scarlight/webhook_subscriptions.json`

## How It Works

1. `hermes webhook subscribe` writes to `~/.scarlight/webhook_subscriptions.json`
...
3. **Check gateway logs:** `grep webhook ~/.scarlight/logs/gateway.log | tail -20`
