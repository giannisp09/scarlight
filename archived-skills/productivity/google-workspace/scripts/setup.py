...
from _hermes_home import display_scarlight_home, get_scarlight_home

SCARLIGHT_HOME = get_scarlight_home()
TOKEN_PATH = SCARLIGHT_HOME / "google_token.json"
CLIENT_SECRET_PATH = SCARLIGHT_HOME / "google_client_secret.json"
PENDING_AUTH_PATH = SCARLIGHT_HOME / "google_oauth_pending.json"
...
def exchange_auth_code(code: str):
    ...
    print(f"Profile-scoped token location: {display_scarlight_home()}/google_token.json")
