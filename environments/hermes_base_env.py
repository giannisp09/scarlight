"""
ScarlightAgentBaseEnv -- Abstract Base Environment for Hermes-Agent + Atropos
...
- Agent loop orchestration via ScarlightAgentLoop
...
class ScarlightAgentEnvConfig(BaseEnvConfig):
    """
...
class ScarlightAgentBaseEnv(BaseEnv):
    """
    ...
    env_config_cls = ScarlightAgentEnvConfig

    def __init__(
        self,
        config: ScarlightAgentEnvConfig,
