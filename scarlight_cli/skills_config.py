"""
Skills configuration for Scarlight Agent.
`scarlight skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.scarlight/config.yaml under:
...
from scarlight_cli.config import cfg_get, load_config, save_config
from scarlight_cli.colors import Colors, color
from scarlight_cli.platforms import PLATFORMS as _PLATFORMS
...
def skills_command(args=None):
    """Entry point for `scarlight skills`."""
    from scarlight_cli.curses_ui import curses_checklist
