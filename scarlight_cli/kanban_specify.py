...
Used by ``scarlight kanban specify [task_id | --all]``. Takes a task that
...
* This module intentionally mirrors ``scarlight_cli/goals.py`` — same aux
...
_SYSTEM_PROMPT = """You are the Kanban triage specifier for the Scarlight Agent board.
...
def _profile_author() -> str:
    """Mirror of ``scarlight_cli.kanban._profile_author``. Kept local to
    avoid a circular import when kanban.py imports this module."""
    return (
        os.environ.get("SCARLIGHT_PROFILE")
