...
class MemoryProvider(ABC):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        kwargs always include:
          - scarlight_home (str): The active SCARLIGHT_HOME directory path. Use this
            for profile-scoped storage instead of hardcoding ``~/.scarlight``.
        ...
        kwargs may also include:
          ...
          - agent_workspace (str): Shared workspace name (e.g. "scarlight").
    ...
    def get_config_schema(self) -> List[Dict[str, Any]]:
        ...
        Used by 'scarlight memory setup' to walk the user through configuration.
    ...
    def save_config(self, values: Dict[str, Any], scarlight_home: str) -> None:
        """Write non-secret config to the provider's native location.

        Called by 'scarlight memory setup' after collecting user inputs.
        ``values`` contains only non-secret fields (secrets go to .env).
        ``scarlight_home`` is the active SCARLIGHT_HOME directory path.
