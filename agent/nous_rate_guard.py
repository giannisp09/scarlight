...
(3 SDK retries x 3 Scarlight retries), and every one of those calls counts
...
def _state_path() -> str:
    ...
    try:
        ...
        base = get_scarlight_home()
    except ImportError:
        base = os.path.join(os.path.expanduser("~"), ".scarlight")
...
def is_genuine_nous_rate_limit(
    *,
    ...
    MiMo, Scarlight, ...) behind one endpoint.  A 429 can mean either:
