#!/usr/bin/env python3
"""Scarlight Agent Release Script
...
VERSION_FILE = REPO_ROOT / "scarlight_cli" / "__init__.py"
...
AUTHOR_MAP = {
    # Scarlight maintainer
    "giannispast9@gmail.com": "giannisp09",
    ...
    "274096618+scarlight-agent-dhabibi@users.noreply.github.com": "dhabibi",
    ...
    "scarlight@nousresearch.com": "NousResearch",
    ...
    "scarlight@noushq.ai": "benbarclay",
    ...
    "scarlight@example.com": "shellybotmoyer",  # PR #18915 (bot-committed)
    ...
    "agent@scarlight.local": "jacdevos",
    ...
    "teknium@scarlight-agent": "teknium1",
    ...
    "sylw3st3rr@gmail.com": "Sylw3ster",  # salvage of #23252 (SCARLIGHT_KANBAN_BOARD restore)
    ...
    "58116817+TurgutKural@users.noreply.github.com": "TurgutKural",  # salvage of #23356 (SCARLIGHT_HOME inject)
...
def parse_coauthors(body: str) -> list:
    ...
    _ignored_emails = {"noreply@anthropic.com", "noreply@github.com",
                       "cursoragent@cursor.com", "scarlight@nousresearch.com"}
...
def generate_changelog(commits, tag_name, semver, repo_url="https://github.com/NousResearch/hermes-agent",
    ...
    lines.append(f"# Scarlight Agent v{semver} ({tag_name})")
    lines.append("")
    ...
    if first_release:
        ...
        lines.append("> for Scarlight Agent. See below for everything included in this initial release.")
        lines.append("")
...
def main():
    parser = argparse.ArgumentParser(description="Scarlight Agent Release Tool")
    ...
    print(f"{'='*60}")
    print(f"  Scarlight Agent Release Preview")
    print(f"{'='*60}")
    ...
    if args.publish:
        ...
        tag_result = git_result(
            "tag", "-a", tag_name, "-m",
            f"Scarlight Agent v{new_version} ({calver_date})\n\nWeekly release"
        )
        ...
        gh_cmd = [
            ...
            "--title", f"Scarlight Agent v{new_version} ({calver_date})",
        ...
        if result and result.returncode == 0:
            ...
            print(
                f"    gh release create {tag_name} --title 'Scarlight Agent v{new_version} ({calver_date})' "
