#!/usr/bin/env python3
"""Build the Scarlight Skills Index — a centralized JSON catalog of all skills.
...
`scarlight skills search/install` can use it without hitting the GitHub API.
...
# Ensure SCARLIGHT_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Scarlight Skills Index...", flush=True)
