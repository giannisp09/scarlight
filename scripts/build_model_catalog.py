#!/usr/bin/env python3
"""Build the Scarlight Model Catalog — a centralized JSON manifest of curated models.
...
Scarlight CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Scarlight release.
...
``https://scarlight-agent.nousresearch.com/docs/api/model-catalog.json``
"""
...
# Ensure SCARLIGHT_HOME is set for imports that touch it at module level.
os.environ.setdefault("SCARLIGHT_HOME", os.path.join(os.path.expanduser("~"), ".scarlight"))

from scarlight_cli.models import OPENROUTER_MODELS, _PROVIDER_MODELS  # noqa: E402
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "scarlight-agent repo",
            "docs": "https://scarlight-agent.nousresearch.com/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
