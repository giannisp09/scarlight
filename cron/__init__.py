"""
Cron job scheduling system for Scarlight Agent.
...
Cron jobs are executed automatically by the gateway daemon:
    scarlight gateway install    # Install as a user service
    sudo scarlight gateway install --system  # Linux servers: boot-time system service
    scarlight gateway            # Or run in foreground
