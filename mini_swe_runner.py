#!/usr/bin/env python3
"""
SWE Runner with Scarlight Trajectory Format

A runner that uses Scarlight-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Scarlight-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Scarlight-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Scarlight format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Scarlight-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Scarlight-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Scarlight Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Scarlight-Agent's built-in execution environments
    and outputs trajectories in Scarlight-Agent format.
    """
    ...
    def _convert_to_scarlight_format(
        self,
        ...
        """
        Convert internal message format to Scarlight trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Scarlight trajectory format
        trajectory = self._convert_to_scarlight_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Scarlight trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Scarlight Trajectory Format")
    print("=" * 60)
