...
Storage path:
- `~/.scarlight/plugins/hermes-achievements/scan_snapshot.json`
...
Checkpoint file (new):
- `~/.scarlight/plugins/hermes-achievements/scan_checkpoint.json`
...
- persisted runtime files:
  - `~/.scarlight/plugins/hermes-achievements/state.json` (existing unlock state)
  - `~/.scarlight/plugins/hermes-achievements/scan_snapshot.json` (new)
  - `~/.scarlight/plugins/hermes-achievements/scan_checkpoint.json` (new)
