...
- Snapshot persisted at `~/.scarlight/plugins/hermes-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.scarlight/plugins/hermes-achievements/scan_checkpoint.json`.
