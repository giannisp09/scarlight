...
```bash
git clone https://github.com/PCinkusz/hermes-achievements ~/.scarlight/plugins/hermes-achievements
```
...
ln -s ~/hermes-achievements ~/.scarlight/plugins/hermes-achievements
```
...
```bash
cd ~/.scarlight/plugins/hermes-achievements
git pull --ff-only
curl http://127.0.0.1:9119/api/dashboard/plugins/rescan
```
