...
echo "HONCHO_API_KEY=***" >> ~/.scarlight/.env
```
...
| Priority | Path | Scope |
|----------|------|-------|
| 1 | `$SCARLIGHT_HOME/honcho.json` | Profile-local (isolated Hermes instances) |
| 2 | `~/.scarlight/honcho.json` | Default profile (shared host blocks) |
