...
const STORAGE_KEY = "scarlight-dashboard-theme";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `scarlight_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "scarlight-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-scarlight-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-scarlight-theme-font", "true");
