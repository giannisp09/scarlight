...
export const tr: Translations = {
  ...
  status: {
    ...
    stopped: "Durduruldu",
    updateScarlight: "Scarlight'i Güncelle",
    updatingScarlight: "Scarlight güncelleniyor…",
  ...
  pluginsPage: {
    ...
    headline:
      "Scarlight eklentilerini keşfedin, yükleyin, etkinleştirin ve güncelleyin (`scarlight plugins` ile eşdeğer).",
    ...
    removeConfirm: "Bu eklenti ~/.scarlight/plugins/ içinden kaldırılsın mı?",
    removeHint: "Yalnızca ~/.scarlight/plugins altındaki kullanıcı tarafından yüklenmiş eklentiler kaldırılabilir.",
  ...
  skills: {
    ...
    filters: "Filtreler",
    noSkills: "Yetenek bulunamadı. Yetenekler ~/.scarlight/skills/ adresinden yüklenir",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Gerçek oturum geçmişinden kazanılan, koleksiyonluk Scarlight rozetleri. Bilinen ama henüz tamamlanmamış başarılar Keşfedildi olarak gösterilir; Gizli başarılar ilk eşleşen davranış görünene kadar saklı kalır.",
      scan_subtitle:
        "Scarlight oturum geçmişi taranıyor. Büyük geçmişlerde ilk tarama 5–10 saniye sürebilir.",
    },
    actions: {
      rescan: "Yeniden tara",
    },
    stats: {
      ...
      latest: "En son",
      latest_hint_empty: "Scarlight'i daha çok çalıştır",
      none_yet: "Henüz yok",
    },
    state: {
      unlocked: "Açıldı",
    ...
    guide: {
      ...
      secret_body:
        "Sırlar, tetikleyicilerini saklı tutar. Scarlight ilgili bir sinyal gördüğünde kart Keşfedildi durumuna geçer ve gereksinimini gösterir.",
      scan_status_header: "Tarama durumu",
      scan_status_body:
        "Scarlight yerel geçmişi bir kez tarıyor; sonra kartlar otomatik olarak görünür. Birkaç saniye sürmesi normaldir, hiçbir şey takılmadı.",
