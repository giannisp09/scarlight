...
export const af: Translations = {
  ...
  status: {
    ...
    stopped: "Gestop",
    updateScarlight: "Werk Scarlight op",
    updatingScarlight: "Besig om Scarlight op te werk…",
  ...
  pluginsPage: {
    ...
    headline:
      "Ontdek, installeer, aktiveer en werk Scarlight-inproppe op (`scarlight plugins` ekwivalent).",
    ...
    removeConfirm: "Verwyder hierdie inprop uit ~/.scarlight/plugins/?",
    removeHint: "Slegs gebruiker-geïnstalleerde inproppe onder ~/.scarlight/plugins kan verwyder word.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "Geen vaardighede gevind nie. Vaardighede word gelaai uit ~/.scarlight/skills/",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Versamelbare Scarlight-kentekens wat verdien word uit werklike sessiegeskiedenis. Bekende, onvoltooide prestasies word as Ontdek vertoon; Geheime prestasies bly verborge totdat die eerste ooreenstemmende gedrag verskyn.",
      scan_subtitle:
        "Scarlight-sessiegeskiedenis word geskandeer. Die eerste skandering kan 5–10 sekondes neem op groot geskiedenisse.",
    },
    actions: {
      rescan: "Herskandeer",
    },
    stats: {
      ...
      latest: "Jongste",
      latest_hint_empty: "gebruik Scarlight meer",
      none_yet: "Nog geen",
    },
    state: {
      unlocked: "Ontsluit",
    ...
    guide: {
      ...
      secret_body:
        "Geheime hou hul presiese sneller verborge. Sodra Scarlight 'n verwante sein sien, word die kaart Ontdek en wys sy vereiste.",
      scan_status_header: "Skanderingstatus",
      scan_status_body:
        "Scarlight skandeer plaaslike geskiedenis een keer, daarna verskyn kaarte outomaties. Niks is vasgevang as dit 'n paar sekondes neem nie.",
