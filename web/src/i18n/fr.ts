...
export const fr: Translations = {
  ...
  status: {
    ...
    stopped: "Arrêté",
    updateScarlight: "Mettre à jour Scarlight",
    updatingScarlight: "Mise à jour de Scarlight…",
  ...
  pluginsPage: {
    ...
    headline:
      "Découvrez, installez, activez et mettez à jour les plugins Scarlight (parité avec `scarlight plugins`).",
    ...
    removeConfirm: "Retirer ce plugin de ~/.scarlight/plugins/ ?",
    removeHint: "Seuls les plugins installés par l'utilisateur sous ~/.scarlight/plugins peuvent être supprimés.",
  ...
  skills: {
    ...
    filters: "Filtres",
    noSkills: "Aucune compétence trouvée. Les compétences sont chargées depuis ~/.scarlight/skills/",
  ...
  config: {
    configPath: "~/.scarlight/config.yaml",
    filters: "Filtres",
    sections: "Sections",
  ...
  achievements: {
    hero: {
      ...
      title: "Scarlight Achievements",
      subtitle:
        "Badges Scarlight à collectionner, gagnés à partir de l'historique réel des sessions. Les succès connus non terminés sont affichés comme Découverts ; les succès secrets restent cachés jusqu'à l'apparition du premier comportement correspondant.",
      scan_subtitle:
        "Analyse de l'historique des sessions Scarlight en cours. Le premier scan peut prendre 5 à 10 secondes sur les historiques volumineux.",
    },
    actions: {
    ...
    stats: {
      ...
      latest: "Dernier",
      latest_hint_empty: "utilisez Scarlight davantage",
    ...
    guide: {
      ...
      secret_body:
        "Les secrets cachent leur déclencheur exact. Dès qu'Scarlight détecte un signal lié, la carte passe à Découvert et affiche son exigence.",
      scan_status_header: "État du scan",
      scan_status_body:
        "Scarlight analyse l'historique local une seule fois, puis les cartes apparaîtront automatiquement. Rien n'est bloqué si cela prend quelques secondes.",
    ...
    share: {
      ...
      tweet_text: "Just unlocked {tier_part}\"{name}\" in Scarlight Agent ☤",
    },
  },
  kanban: {
