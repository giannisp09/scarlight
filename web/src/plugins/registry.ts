 ...
 *
 * Plugins call window.__SCARLIGHT_PLUGINS__.register(name, Component)
...
declare global {
  interface Window {
    __SCARLIGHT_PLUGIN_SDK__: unknown;
    __SCARLIGHT_PLUGINS__: {
...
export function exposePluginSDK() {
  window.__SCARLIGHT_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__SCARLIGHT_PLUGIN_SDK__ = {
