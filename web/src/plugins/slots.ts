 ...
 * `window.__SCARLIGHT_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Scarlight brand in the top bar
 ...
 *  `window.__SCARLIGHT_PLUGINS__.registerSlot(...)`.
 *
