...
def _get_scarlight_version() -> str:
    """Return the scarlight-agent package version, or 'dev' if unavailable."""
    try:
...
def build_user_agent() -> str:
    ...
    Format::
        ...
        QQBotAdapter/<qqbot_version> (Python/<py_version>; <os>; Scarlight/<scarlight_version>)
    ...
    scarlight_version = _get_scarlight_version()
    return f"QQBotAdapter/{QQBOT_VERSION} (Python/{py_version}; {os_name}; Scarlight/{scarlight_version})"
