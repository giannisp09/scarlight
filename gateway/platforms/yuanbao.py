...
try:
    ...
    _SCARLIGHT_VERSION = "0.0.0"

_APP_VERSION = _SCARLIGHT_VERSION
_BOT_VERSION = _SCARLIGHT_VERSION
_YUANBAO_INSTANCE_ID = str(SCARLIGHT_INSTANCE_ID)  # single source: yuanbao_proto.SCARLIGHT_INSTANCE_ID
