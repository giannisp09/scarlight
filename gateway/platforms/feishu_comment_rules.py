...
Config: ~/.scarlight/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.scarlight/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_scarlight_home()`` helper (SCARLIGHT_HOME-aware and
...
RULES_FILE = get_scarlight_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_scarlight_home() / "feishu_comment_pairing.json"
